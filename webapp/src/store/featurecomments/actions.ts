...
export const createFeatureComment = (x: IFeatureComment) => action(ActionTypes.CREATE_FEATURE_COMMENT, x)

export interface loadFeatureComments { type: ActionTypes.LOAD_FEATURE_COMMENTS, payload: IFeatureComment[] }
export const loadFeatureComments = (x: IFeatureComment[]) => action(ActionTypes.LOAD_FEATURE_COMMENTS, x)

export interface updateFeatureComment { type: ActionTypes.UPDATE_FEATURE_COMMENT, payload: IFeatureComment }
export const updateFeatureComment = (x: IFeatureComment) => action(ActionTypes.UPDATE_FEATURE_COMMENT, x)

export interface deleteFeatureComment { type: ActionTypes.DELETE_FEATURE_COMMENT, payload: string }
export const deleteFeatureComment = (x: string) => action(ActionTypes.DELETE_FEATURE_COMMENT, x)
